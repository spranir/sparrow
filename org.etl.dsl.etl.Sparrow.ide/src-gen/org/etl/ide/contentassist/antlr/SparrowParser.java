		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExecutescriptAccess().getGroup(), "rule__Executescript__Group__0");
					...
					put(grammarAccess.getExecutescriptAccess().getNameAssignment_1(), "rule__Executescript__NameAssignment_1");
					put(grammarAccess.getExecutescriptAccess().getUsingAssignment_2(), "rule__Executescript__UsingAssignment_2");
					put(grammarAccess.getExecutescriptAccess().getValueAssignment_5(), "rule__Executescript__ValueAssignment_5");
