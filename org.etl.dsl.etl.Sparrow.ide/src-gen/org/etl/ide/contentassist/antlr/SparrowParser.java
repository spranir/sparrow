		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getOnErrorAccess().getGroup(), "rule__OnError__Group__0");
					...
					put(grammarAccess.getProcessAccess().getActionAssignment_3(), "rule__Process__ActionAssignment_3");
					put(grammarAccess.getProcessAccess().getOnErrorAssignment_4(), "rule__Process__OnErrorAssignment_4");
					put(grammarAccess.getProcessAccess().getFinallyAssignment_5(), "rule__Process__FinallyAssignment_5");
					put(grammarAccess.getFinallyAccess().getActionAssignment(), "rule__Finally__ActionAssignment");
					put(grammarAccess.getOnErrorAccess().getActionAssignment_1(), "rule__OnError__ActionAssignment_1");
					put(grammarAccess.getCallprocessAccess().getNameAssignment_1(), "rule__Callprocess__NameAssignment_1");
					put(grammarAccess.getCallprocessAccess().getTargetAssignment_2(), "rule__Callprocess__TargetAssignment_2");
					put(grammarAccess.getCallprocessAccess().getValueAssignment_5(), "rule__Callprocess__ValueAssignment_5");
					put(grammarAccess.getUpdatedauditAccess().getNameAssignment_1(), "rule__Updatedaudit__NameAssignment_1");
					put(grammarAccess.getUpdatedauditAccess().getLogsinkAssignment_2(), "rule__Updatedaudit__LogsinkAssignment_2");
					put(grammarAccess.getUpdatedauditAccess().getValueAssignment_5(), "rule__Updatedaudit__ValueAssignment_5");
					put(grammarAccess.getSmsAccess().getNameAssignment_1(), "rule__Sms__NameAssignment_1");
					put(grammarAccess.getSmsAccess().getTargetAssignment_2(), "rule__Sms__TargetAssignment_2");
					put(grammarAccess.getSmsAccess().getValueAssignment_5(), "rule__Sms__ValueAssignment_5");
					put(grammarAccess.getSlackAccess().getNameAssignment_1(), "rule__Slack__NameAssignment_1");
					put(grammarAccess.getSlackAccess().getTeamAssignment_2(), "rule__Slack__TeamAssignment_2");
					put(grammarAccess.getSlackAccess().getChannelAssignment_3(), "rule__Slack__ChannelAssignment_3");
					put(grammarAccess.getSlackAccess().getValueAssignment_6(), "rule__Slack__ValueAssignment_6");
					put(grammarAccess.getGooglecalAccess().getNameAssignment_1(), "rule__Googlecal__NameAssignment_1");
					put(grammarAccess.getGooglecalAccess().getCalidAssignment_2(), "rule__Googlecal__CalidAssignment_2");
					put(grammarAccess.getGooglecalAccess().getAuthstoreAssignment_3(), "rule__Googlecal__AuthstoreAssignment_3");
					put(grammarAccess.getGooglecalAccess().getUseraccountAssignment_4(), "rule__Googlecal__UseraccountAssignment_4");
					put(grammarAccess.getGooglecalAccess().getTitleAssignment_5(), "rule__Googlecal__TitleAssignment_5");
					put(grammarAccess.getGooglecalAccess().getStartAssignment_6(), "rule__Googlecal__StartAssignment_6");
					put(grammarAccess.getGooglecalAccess().getEndAssignment_7(), "rule__Googlecal__EndAssignment_7");
					put(grammarAccess.getGooglecalAccess().getNotifyAssignment_8(), "rule__Googlecal__NotifyAssignment_8");
					put(grammarAccess.getGooglecalAccess().getValueAssignment_10(), "rule__Googlecal__ValueAssignment_10");
					put(grammarAccess.getCopydataAccess().getNameAssignment_1(), "rule__Copydata__NameAssignment_1");
					put(grammarAccess.getCopydataAccess().getSourceAssignment_2(), "rule__Copydata__SourceAssignment_2");
					put(grammarAccess.getCopydataAccess().getToAssignment_3(), "rule__Copydata__ToAssignment_3");
					put(grammarAccess.getCopydataAccess().getValueAssignment_6(), "rule__Copydata__ValueAssignment_6");
					put(grammarAccess.getWriteCsvAccess().getNameAssignment_1(), "rule__WriteCsv__NameAssignment_1");
					put(grammarAccess.getWriteCsvAccess().getSourceAssignment_2(), "rule__WriteCsv__SourceAssignment_2");
					put(grammarAccess.getWriteCsvAccess().getToAssignment_3(), "rule__WriteCsv__ToAssignment_3");
					put(grammarAccess.getWriteCsvAccess().getDelimAssignment_5(), "rule__WriteCsv__DelimAssignment_5");
					put(grammarAccess.getWriteCsvAccess().getValueAssignment_8(), "rule__WriteCsv__ValueAssignment_8");
					put(grammarAccess.getLoadCsvAccess().getNameAssignment_1(), "rule__LoadCsv__NameAssignment_1");
					put(grammarAccess.getLoadCsvAccess().getSourceAssignment_2(), "rule__LoadCsv__SourceAssignment_2");
					put(grammarAccess.getLoadCsvAccess().getToAssignment_3(), "rule__LoadCsv__ToAssignment_3");
					put(grammarAccess.getLoadCsvAccess().getDelimAssignment_5(), "rule__LoadCsv__DelimAssignment_5");
					put(grammarAccess.getLoadCsvAccess().getValueAssignment_8(), "rule__LoadCsv__ValueAssignment_8");
					put(grammarAccess.getTransformAccess().getNameAssignment_1(), "rule__Transform__NameAssignment_1");
					put(grammarAccess.getTransformAccess().getUsingAssignment_2(), "rule__Transform__UsingAssignment_2");
					put(grammarAccess.getTransformAccess().getValueAssignment_5(), "rule__Transform__ValueAssignment_5");
