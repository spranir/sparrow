		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRestAccess().getHeaderdatafromAssignment_11(), "rule__Rest__HeaderdatafromAssignment_11");
					put(grammarAccess.getRestAccess().getHeaderdataAssignment_14(), "rule__Rest__HeaderdataAssignment_14");
					put(grammarAccess.getRestAccess().getPostdatafromAssignment_17(), "rule__Rest__PostdatafromAssignment_17");
					put(grammarAccess.getRestAccess().getParentNameAssignment_22(), "rule__Rest__ParentNameAssignment_22");
					put(grammarAccess.getRestAccess().getParentdataAssignment_23(), "rule__Rest__ParentdataAssignment_23");
