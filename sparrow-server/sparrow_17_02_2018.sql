...
-- Dumping data for table spw_config.config_audit: ~0 rows (approximately)
...
-- Dumping data for table spw_config.spw_common_config: ~2 rows (approximately)
...
-- Dumping data for table spw_config.spw_process_config: ~7 rows (approximately)
