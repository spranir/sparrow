...
public class ChimeraRestClient implements RestClient {
    ...
    static {
    	if(System.getProperty(MIFOS_ENDPOINT)!=null && 
    			System.getProperty(MIFOS_ENDPOINT).contains("localhost")) {
    ...
    public ChimeraRestClient(String baseURL, String userName, String password, String tenantId) {
		super();
