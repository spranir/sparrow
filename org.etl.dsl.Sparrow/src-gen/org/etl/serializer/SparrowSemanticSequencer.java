...
public class SparrowSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == SparrowPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case SparrowPackage.COPYDATA:
				if(context == grammarAccess.getActionRule() ||
				   context == grammarAccess.getCopydataRule()) {
			...
			case SparrowPackage.EXECUTESCRIPT:
				if(context == grammarAccess.getActionRule() ||
				   context == grammarAccess.getExecutescriptRule()) {
					sequence_Executescript(context, (Executescript) semanticObject); 
					return; 
				}
				else break;
			case SparrowPackage.LOAD_CSV:
				if(context == grammarAccess.getActionRule() ||
				   context == grammarAccess.getLoadCsvRule()) {
			...
			case SparrowPackage.WRITE_CSV:
				if(context == grammarAccess.getActionRule() ||
				   context == grammarAccess.getWriteCsvRule()) {
	 ...
	 */
	protected void sequence_Copydata(EObject context, Copydata semanticObject) {
		...
		feeder.accept(grammarAccess.getCopydataAccess().getValueSelectStatementParserRuleCall_12_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_Executescript(EObject context, Executescript semanticObject) {
	 ...
	 *     value=SelectStatement
	 */
	protected void sequence_LoadCsv(EObject context, LoadCsv semanticObject) {
		if(errorAcceptor != null) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getLoadCsvAccess().getValueSelectStatementParserRuleCall_16_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_Process(EObject context, org.etl.sparrow.Process semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     value=SelectStatement
	 */
	protected void sequence_WriteCsv(EObject context, WriteCsv semanticObject) {
		if(errorAcceptor != null) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getWriteCsvAccess().getValueSelectStatementParserRuleCall_16_0(), semanticObject.getValue());
		feeder.finish();
	}
}
