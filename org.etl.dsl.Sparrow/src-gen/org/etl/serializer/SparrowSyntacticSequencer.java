...
public class SparrowSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SparrowGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (SparrowGrammarAccess) access;
