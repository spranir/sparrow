...
* generated by Xtext
*/
package org.etl.ui.contentassist.antlr;
...
public class SparrowParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.etl.ui.contentassist.antlr.internal.InternalSparrowParser createParser() {
		org.etl.ui.contentassist.antlr.internal.InternalSparrowParser result = new org.etl.ui.contentassist.antlr.internal.InternalSparrowParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getCopydataAccess().getValueAssignment_12(), "rule__Copydata__ValueAssignment_12");
					put(grammarAccess.getWriteCsvAccess().getValueAssignment_16(), "rule__WriteCsv__ValueAssignment_16");
					put(grammarAccess.getLoadCsvAccess().getValueAssignment_16(), "rule__LoadCsv__ValueAssignment_16");
					put(grammarAccess.getExecutescriptAccess().getValueAssignment_9(), "rule__Executescript__ValueAssignment_9");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.etl.ui.contentassist.antlr.internal.InternalSparrowParser typedParser = (org.etl.ui.contentassist.antlr.internal.InternalSparrowParser) parser;
