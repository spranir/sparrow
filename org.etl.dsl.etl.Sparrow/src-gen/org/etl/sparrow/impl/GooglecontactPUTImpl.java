 ...
 * </p>
 * <ul>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getPrivateKey <em>Private Key</em>}</li>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getPtwelveFile <em>Ptwelve File</em>}</li>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getProject <em>Project</em>}</li>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getImpersonatedUser <em>Impersonated User</em>}</li>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getDbSrc <em>Db Src</em>}</li>
 *   <li>{@link org.etl.sparrow.impl.GooglecontactPUTImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GooglecontactPUTImpl extends ActionImpl implements GooglecontactPUT
{
  ...
  {
    return SparrowPackage.Literals.GOOGLECONTACT_PUT;
  }
  ...
  public void setAccount(String newAccount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__ACCOUNT, oldAccount, account));
  }
  ...
  public void setPrivateKey(String newPrivateKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__PRIVATE_KEY, oldPrivateKey, privateKey));
  }
  ...
  public void setPtwelveFile(String newPtwelveFile)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__PTWELVE_FILE, oldPtwelveFile, ptwelveFile));
  }
  ...
  public void setProject(String newProject)
  {
    ...
    project = newProject;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__PROJECT, oldProject, project));
  }
  ...
  public void setImpersonatedUser(String newImpersonatedUser)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__IMPERSONATED_USER, oldImpersonatedUser, impersonatedUser));
  }
  ...
  public void setDbSrc(String newDbSrc)
  {
    ...
    dbSrc = newDbSrc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__DB_SRC, oldDbSrc, dbSrc));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SparrowPackage.GOOGLECONTACT_PUT__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SparrowPackage.GOOGLECONTACT_PUT__ACCOUNT:
        return getAccount();
      case SparrowPackage.GOOGLECONTACT_PUT__PRIVATE_KEY:
        return getPrivateKey();
      case SparrowPackage.GOOGLECONTACT_PUT__PTWELVE_FILE:
        return getPtwelveFile();
      case SparrowPackage.GOOGLECONTACT_PUT__PROJECT:
        return getProject();
      case SparrowPackage.GOOGLECONTACT_PUT__IMPERSONATED_USER:
        return getImpersonatedUser();
      case SparrowPackage.GOOGLECONTACT_PUT__DB_SRC:
        return getDbSrc();
      case SparrowPackage.GOOGLECONTACT_PUT__VALUE:
        return getValue();
    }
