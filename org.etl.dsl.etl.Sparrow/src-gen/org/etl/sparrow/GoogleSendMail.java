 ...
 *   <li>{@link org.etl.sparrow.GoogleSendMail#getProject <em>Project</em>}</li>
...
public interface GoogleSendMail extends Action
{
   ...
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_Account()
   * @model
   * @generated
   */
  String getAccount();
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getAccount <em>Account</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_PrivateKey()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getPrivateKey <em>Private Key</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_PtwelveFile()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getPtwelveFile <em>Ptwelve File</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_Project()
   * @model
   * @generated
   */
  String getProject();
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getProject <em>Project</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_ImpersonatedUser()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getImpersonatedUser <em>Impersonated User</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setDbSrc(String)
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_DbSrc()
   * @model
   * @generated
   */
  String getDbSrc();
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getDbSrc <em>Db Src</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(String)
   * @see org.etl.sparrow.SparrowPackage#getGoogleSendMail_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.etl.sparrow.GoogleSendMail#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
